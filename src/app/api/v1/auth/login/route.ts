...
export const POST = apiHandler(
  async ({ body, ip, userAgent }) => {
    ...
    const sessionUser = { id: user.id, username: user.username, fullName: user.fullName, role: user.role, workshopId: user.workshopId, phone: user.phone, workerId: user.workerId }
