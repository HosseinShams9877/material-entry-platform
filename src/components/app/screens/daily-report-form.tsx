...
import { Loader2, Save, Send, Eye, CalendarDays } from 'lucide-react'
import { toast } from 'sonner'
import { Button } from '@/components/ui/button'
import { Input } from '@/components/ui/input'
import { Textarea } from '@/components/ui/textarea'
import { api, ClientApiError, type DailyReportDetail, type MasterDataWithSupervisors } from '@/lib/client'
...
import { todayISO, formatJalaliFromISO, formatJalaliTehranToISO } from '@/lib/fa'
  ...
  useEffect(() => {
    ...
    api
      ...
      .then(({ report }) => {
        ...
        setReportDate(formatJalaliTehranToISO(report.reportDate))
        setLoaded(true)
      })
      .catch(() => {
