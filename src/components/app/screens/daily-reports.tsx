...
import { Plus, ChevronLeft, CalendarDays, ListTodo, Mic } from 'lucide-react'
...
import { formatJalaliFromISO, formatRelative, toFa } from '@/lib/fa'
              ...
              >
                ...
                <div className="flex items-center gap-2 mt-2 flex-wrap text-[11px] text-muted-foreground">
                  <span className="inline-flex items-center gap-1">
                    ...
                    {formatJalaliFromISO(new Date(r.reportDate).toISOString().slice(0, 10))}
                  </span>
