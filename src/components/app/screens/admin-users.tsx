      ...
      <ScreenHeader
        ...
        right={
          <Button
            ...
            onClick={() =>
              setForm({ username: '', password: '', fullName: '', role: 'WORKSHOP_SUPERVISOR', phone: '', workshopId: null, workshopAccessIds: [], projectIds: [], isActive: true })
            }
          >
        ...
        <div className="fixed inset-0 z-50 flex items-end" onClick={() => setForm(null)}>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="block text-xs font-medium mb-1.5">کارگاه اصلی (برای سرپرست)</label>
